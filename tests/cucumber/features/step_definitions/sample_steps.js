(function () {
  ...
  module.exports = function () {
    ...
    this.Then(/^I should see the page title "([^"]*)"$/, function (expectedTitle, callback) {
      // you can use chai-as-promised in step definitions also
      this.browser
          .waitForVisible('h1.pageTitle', 2000).  // WebdriverIO chain-able promise magic
        getText('h1.pageTitle').should.become(expectedTitle).and.notify(callback);
    });
